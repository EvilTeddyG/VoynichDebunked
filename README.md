...
The following control is active and retained for auditability. It is not part of the pending "must be added" backlog.
...
2. Current frozen run manifest: `artifacts/run_manifest_latest.json`
3. Artifact-to-claim mapping: `docs/results/artifact_claim_index.md`
